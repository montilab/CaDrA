      ...
      tagList(
        ...
        conditionalPanel(
          ...
          selectInput(
            ...
            label = HTML("Input Score", paste0('<a class="tooltip-txt" data-html="true" data-tooltip-toggle="tooltip" data-placement="top" title=\"The random simulated input scores are generated from rnorm(n=ncol(sim.ES), mean=0, sd=1) with seed=123.\">?</a>')), 
        ...
        conditionalPanel(
          ...
          fileInput(
            inputId = ns("ES_file"), 
            label = strong(span(style = "color: red;", "*"), "Feature Set file:"), 
            width = "100%"
          ),
          radioButtons(
            inputId = ns("ES_file_type"), 
            label = HTML("File type", paste0('<a class="tooltip-txt" data-html="true" data-tooltip-toggle="tooltip" data-placement="top" title=\"NOTE: If \'.csv\', it must be a comma-delimited text file including a \'Features\' column name that contains unique feature labels and a header line with sample names that match those in the \'Input Score\' vector. Otherwise (if \'.rds\'), it must be a Biobase::ExpressionSet object.\">?</a>')), 
            choices = c(".csv", ".rds"), 
            selected = ".csv", 
            inline = TRUE
          )
        ...
        conditionalPanel(
          ...
          fileInput(
            ...
            label = strong(span(style = "color: red;", "*"), "Input Score file:"), 
            width = "100%"
          ),
          radioButtons(
            inputId = ns("input_score_file_type"), 
            label = HTML("File type", paste0('<a class="tooltip-txt" data-html="true" data-tooltip-toggle="tooltip" data-placement="top" title=\"NOTE: The input score file must be a data frame with two columns (Samples and Scores) and the Samples must match the colnames of the \'Feature Set\'.\">?</a>')), 
            choices = c(".csv", ".rds"), 
            selected = ".csv", 
            inline = TRUE
          )
        ...
        conditionalPanel(
          ...
          conditionalPanel(
            ...
            radioButtons(
              ...
              label = HTML("File type", paste0('<a class="tooltip-txt" data-html="true" data-tooltip-toggle="tooltip" data-placement="top" title=\"NOTE: The weights file must be a data frame with two columns (Samples and Weights) and the Samples must match the colnames of the \'Feature Set\'.\">?</a>')), 
              choices=c(".csv", ".rds"), 
              selected = ".csv", 
              inline = TRUE
            )     
