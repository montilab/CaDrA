...
#'
#' A simulated vector of continuous scores generated from rnorm(n=ncol(sim_ES),
#' mean=0, sd=1) with set.seed(123) based on the number of samples in the
#' simulated dataset (sim_ES)
#'
#' @docType data
#'
#' @usage data(sim_Scores)
#'
#' @format A vector of continuous scores randomly generated from rnorm(n=ncol(sim_ES),
#' mean=0, sd=1) with set.seed(123) based on the number of samples in the
#' simulated dataset (sim_ES)
#'
