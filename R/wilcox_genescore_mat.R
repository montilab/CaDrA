...
#' @param rank a vector of ranks to use when performing the Wilcoxon test. Default is NULL. If NULL, then samples are assumed to be ordered by increasing ranking. Value passed to wilcox.genescore() function 
#' @param alternative a character string specifying the alternative hypothesis, must be one of "two.sided","less" or "greater". Value passed to wilcox.genescore() function
...
)
{
  ...
  # source("/Users/reinachau/Documents/CaDrA/CaDrA/R/wilcox_genescore.R")
  # 
  ...
  # mat <- exprs(sim.ES)
  # rank = NULL                                   # a vector of ranks to use when performing the Wilcoxon test
