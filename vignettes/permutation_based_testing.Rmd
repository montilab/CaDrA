...
```{r ks.perm.res, include=FALSE}

# Load pre-computed permutation-based testings
# See ?perm_res for more information
data("perm_res")
...
perm_res <- CaDrA::CaDrA(
  ...
  n_perm = 1000,               # Number of permutations to perform
  plot = FALSE,                # We will plot later
  ncores = 4                   # Number of cores to perform parallelization
)
```
